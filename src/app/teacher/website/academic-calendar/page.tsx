...
export const metadata = {
  title: "Manage Academic Calendar - Website Admin",
  description: "Manage the hero banner and full schedule flyer for the Academic Calendar page.",
};

export default function AcademicCalendarCMSPage() {
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-muted font-medium mt-1">
          Customize the hero section banner and upload the official schedule/calendar image displayed on the Academic Calendar page.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-border/60 rounded-3xl p-6 shadow-sm flex flex-col h-full group hover:shadow-md hover:border-accent/50 transition-all">
          ...
          <p className="text-sm text-muted mb-6 flex-grow leading-relaxed">
            Edit the main title, subtitle, eyebrow text, description, and cover image of the Academic Calendar top header section.
          </p>
          <Link 
            href="/teacher/website/academic-calendar/hero"
        ...
        {/* Card 2: Calendar Image (Card Section) */}
        <div className="bg-white border border-border/60 rounded-3xl p-6 shadow-sm flex flex-col h-full group hover:shadow-md hover:border-accent/50 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-2xl bg-bg flex items-center justify-center text-primary group-hover:bg-accent group-hover:text-white transition-colors">
            ...
            <div>
              <h3 className="font-bold text-primary text-lg">Calendar Image (Card)</h3>
              <p className="text-xs text-accent font-semibold">Full Schedule Flyer</p>
            </div>
          </div>
          <p className="text-sm text-muted mb-6 flex-grow leading-relaxed">
            Upload or select the massive high-resolution academic routine/schedule image. This image will be displayed full-view on the page.
          </p>
          <Link 
            href="/teacher/website/academic-calendar/card"
          ...
          >
            Manage Calendar Image <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
      </div>
    </div>
