...
export const teacherNavItems: NavItem[] = [
  ...
  { label: "Finance Management", href: "/teacher/finance", icon: WalletCards },
...
export const websiteAdminNavItems: NavItem[] = [
  ...
  { 
    ...
    icon: FileText,
    subItems: [
      { label: "Hero Section", href: "/teacher/website/materials/hero" },
      { label: "Categories", href: "/teacher/website/materials/categories" },
      { label: "Manage Materials", href: "/teacher/website/materials/manage" },
    ]
  },
  { 
  ...
  { 
    ...
    icon: Calendar,
    subItems: [
      { label: "Hero Banner", href: "/teacher/website/news-events/hero" },
      { label: "Categories", href: "/teacher/website/news-events/categories" },
      { label: "Cards & Body", href: "/teacher/website/news-events/body" },
    ]
  },
  { 
    label: "Reviews Page", 
  ...
  return (
    <div className={cn("flex flex-col h-full bg-primary-dark text-white border-r border-slate-900", className)}>
      ...
      <div className="flex items-center px-6 py-5 border-b border-slate-900 bg-slate-950/20">
        <Image src="/images/alternate_logo.png" alt="Shifat's Tales Logo" width={160} height={40} className="object-contain" />
      </div>
